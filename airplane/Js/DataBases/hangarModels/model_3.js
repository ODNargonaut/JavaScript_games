...
class Model_3
{
  ...
  model = 
  [
    {color: "#008000", price: 9, buy: false},
    {color: "#008000", price: 99, buy: false},
    {color: "#008000", price: 999, buy: false},
    {color: "#008000", price: 9999, buy: false},
    {color: "#008000", price: 99999, buy: false},
  ];
  ...
  createModel()
  {
    ...
    geometry.vertices[4].z -= 40;
    geometry.vertices[5].z += 40;
